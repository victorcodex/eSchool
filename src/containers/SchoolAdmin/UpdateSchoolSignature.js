...
class UpdateSchoolSignature extends Component {
    ...
    handleSubmit = (event) => { // on form submit
        ...
        this.processUpdateSignature();
    };

    processUpdateSignature = (event) => { // process update signature

        if (this.signature.files.length < 1) { // check signature
            this.setState({errorMessage: 'Signature field is required'});
            return false;
        }

        var data = new FormData();
        data.append('signature', new Blob([this.signature.files[0]]));
        ...
        localforage.getItem('SchoolAdminToken', (err, value) => {
            ...
            if(value) {
                ...
                fetch( GeneralApis.API_SCHOOL_ADMIN_BASEURL + GeneralVariables.SCHOOL_ID +'/signature', {  // HTTP POST REQUEST
                    method: 'POST',
                    body: data,
                    headers: {
                        ...
                        <div className="row wrapper border-bottom white-bg page-heading">
                            <div className="col-lg-10">
                                ...
                                <ol className="breadcrumb">
                                    ...
                                    <li className="active">
                                        <strong>Update School signature</strong>
                                    </li>
                                </ol>
                            </div>
                                    ...
                                    <div className="ibox float-e-margins">
                                        ...
                                        <div className="ibox-content">
                                            ...
                                            <form ref="uploadForm" className="form-horizontal" encType="multipart/form-data" onSubmit={this.handleSubmit}>
                                                ...
                                                <div className="form-group"><label className="col-sm-2 control-label">Signature</label>
                                                ...
                                                <div className="form-group">
                                                    <div className="col-sm-4 col-sm-offset-2">
                                                        ...
                                                        <input type="submit" value="Update Signature" className="btn btn-primary" />
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
export default UpdateSchoolSignature;