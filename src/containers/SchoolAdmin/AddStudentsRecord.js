...
class AddStudentsRecord extends Component {
    ...
    processAddStudents = (event) => { // process add students

        if (this.students.files.length < 1) { // check students
            this.setState({errorMessage: 'Students field is required'});
            // this.students.focus();
            return false;
        }

        var data = new FormData();
        data.append('students', new Blob([this.students.files[0]]));
        ...
        localforage.getItem('SchoolAdminToken', (err, value) => {
            ...
            if(value) {
                ...
                fetch( GeneralApis.API_SCHOOL_ADMIN_BASEURL + GeneralVariables.SCHOOL_ID +'/students', {  // HTTP POST REQUEST
                    method: 'POST',
                    body: data,
                    headers: {
                                    ...
                                    <div className="ibox float-e-margins">
                                        ...
                                        <div className="ibox-content">
                                            ...
                                            <form ref="uploadForm" className="form-horizontal" encType="multipart/form-data" onSubmit={this.handleSubmit}>
                                                ...
                                                <div className="form-group"><label className="col-sm-2 control-label">Students</label>

                                                    <div className="col-sm-10">
                                                        <input
                                                            name="students"
                                                            ref={(input) => { this.students = input; }}
                                                            type="file"
...
export default AddStudentsRecord;